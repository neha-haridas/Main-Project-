...
#######################Add Rooms########################################333333333
# def Addroom(request):
#     # cat = Room.objects.filter(room_type=True)
#     user=request.user
#     if request.method == "POST":
...
#         # category = Room.objects.get(room_type=True)
...
#         'choices': choices
#     }
#         val = Room(user_id=user.id,name=name,description=description,room_image=room_image,price=price,available=available)
#         val.save()  
#         add = Room.objects.filter()
